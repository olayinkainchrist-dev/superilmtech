...
export const capabilities = [
  { icon: Server, title: "Backend APIs", text: "FastAPI, Node.js, REST APIs, authentication, role-based access." },
  { icon: Globe2, title: "Frontend Systems", text: "React, Next.js, dashboards, responsive apps, admin portals." },
  { icon: Database, title: "Databases", text: "PostgreSQL, SQLite, SQLAlchemy, data modeling, reporting." },
  { icon: Cloud, title: "Cloud Deployment", text: "Vercel, Render, Docker-ready architecture, SaaS deployment." },
  { icon: BarChart3, title: "Analytics", text: "KPIs, charts, insights, business intelligence, forecasting." },
  { icon: Lock, title: "Security", text: "JWT, permissions, secure flows, audit-friendly structure." }
]
...
export const pricing = [
  {
    ...
    features: ["Company website", "Basic dashboard", "Contact forms", "Deployment support"]
  },
  {
    name: "Growth",
    price: "Custom",
    description: "For growing businesses that need automation and scalable software.",
    features: ["Web app", "Admin panel", "Database", "Authentication", "Cloud deployment"],
    highlighted: true
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "For companies that need advanced systems, integrations, and SaaS platforms.",
    features: ["SaaS platform", "APIs", "AI tools", "Multi-tenant system", "Priority support"]
  }
]